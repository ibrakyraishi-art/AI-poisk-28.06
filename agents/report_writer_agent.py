    ...
    *,
    ...
    return Task(
        description=(
            ...
            "(ReviewData, NewsData, AnalystOutput).\n"
            "2. If you need additional details or quotes, use memory_search.\n"
            "3. Draft the full report JSON:\n"
            "   - executive_summary: 3-5 sentences, written for senior management.\n"
            "     State the key competitive position, top user concern, and #1 opportunity.\n"
            "   - review_themes: take directly from ReviewData context.\n"
            "   - swot: take directly from AnalystOutput context.\n"
            "   - competitors: empty list (filled in Stage 5).\n"
            "   - recommendations: 3-5 items, ordered by impact. Be specific.\n"
            "     Good: 'Prioritise fixing Android GPS accuracy in the next sprint — "
            "it is the #1 driver of 1-star reviews.'\n"
            "     Bad: 'Improve the app.'\n"
            f"   - generated_at: today's date in ISO 8601 format.\n"
            "4. Call generate_report with the complete JSON. Fix any validation errors "
            "and retry if needed.\n"
        ...
        expected_output=(
            ...
            "swot (AnalystOutput), competitors (empty list), "
